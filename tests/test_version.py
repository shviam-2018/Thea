...
from solace import __version__, display_version
from solace.__main__ import build_parser


class VersionTests(unittest.TestCase):
    def test_canonical_pep_440_version(self):
        self.assertEqual(__version__, "0.2.0a1")

    def test_human_readable_version_is_derived(self):
        self.assertEqual(display_version(), "0.2.0-alpha.1")
    ...
    def test_cli_version_uses_package_version(self):
        ...
        self.assertEqual(output.getvalue().strip(), f"Solace {display_version()}")
